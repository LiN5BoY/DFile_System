...
Registry::Registry() {
    ...
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/JXCqmlTools/qml/page/HC_Excel_Census.qml"), &QmlCacheGeneratedCode::_qt_qml_JXCqmlTools_qml_page_HC_Excel_Census_qml::unit);
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/JXCqmlTools/qml/page/CurveAnalysisTool.qml"), &QmlCacheGeneratedCode::_qt_qml_JXCqmlTools_qml_page_CurveAnalysisTool_qml::unit);
